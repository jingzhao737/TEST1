        ...
        try:
            ...
            if 'tool_calls' in data:
                ...
                for tc in data['tool_calls']:
                    ...
                    # For nested JS files
                    if filename == 'premium-interactions.js' or filename == 'hover-preview.js' or filename == 'stars.js' or filename == 'hanging-circles.js':
                        if not os.path.exists(target_path):
                            ...
                            if not os.path.exists(target_path) and filename == 'premium-interactions.js':
                                target_path = os.path.join(project_dir, filename) # It was originally at root in some steps
